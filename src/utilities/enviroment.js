...
module.exports = class Environment {
    ...
    _setEnvironment() {
        ...
        process.env.PASSWORD = (process.env.PASSWORD ? process.env.PASSWORD : this.settings.password);
        process.env.STORE = (process.env.STORE ? process.env.STORE : this.settings.store);
        process.env.IGNORE_FILES = (process.env.IGNORE_FILES ? process.env.IGNORE_FILES : this.settings.ignore.join(':'));
    }
